...
public class Main_boj_5373_sik {
	...
	public static int[][][] edgeMapping = {
			{ { 2, 0, 2 }, { 2, 0, 1 }, { 2, 0, 0 }, { 4, 2, 2 }, { 4, 1, 2 }, { 4, 0, 2 }, { 3, 2, 0 }, { 3, 2, 1 },
					{ 3, 2, 2 }, { 5, 0, 0 }, { 5, 1, 0 }, { 5, 2, 0 } },
			{ { 2, 2, 0 }, { 2, 2, 1 }, { 2, 2, 2 }, { 5, 2, 2 }, { 5, 1, 2 }, { 5, 0, 2 }, { 3, 0, 2 }, { 3, 0, 1 },
					{ 3, 0, 0 }, { 4, 0, 0 }, { 4, 1, 0 }, { 4, 2, 0 } },
			{ { 0, 2, 0 }, { 0, 2, 1 }, { 0, 2, 2 }, { 5, 2, 0 }, { 5, 2, 1 }, { 5, 2, 2 }, { 1, 0, 2 }, { 1, 0, 1 },
					{ 1, 0, 0 }, { 4, 2, 0 }, { 4, 2, 1 }, { 4, 2, 2 } },
			{ { 1, 2, 0 }, { 1, 2, 1 }, { 1, 2, 2 }, { 5, 0, 2 }, { 5, 0, 1 }, { 5, 0, 0 }, { 0, 0, 2 }, { 0, 0, 1 },
					{ 0, 0, 0 }, { 4, 0, 2 }, { 4, 0, 1 }, { 4, 0, 0 } },
			{ { 0, 0, 0 }, { 0, 1, 0 }, { 0, 2, 0 }, { 2, 0, 0 }, { 2, 1, 0 }, { 2, 2, 0 }, { 1, 0, 0 }, { 1, 1, 0 },
					{ 1, 2, 0 }, { 3, 0, 0 }, { 3, 1, 0 }, { 3, 2, 0 } },
			{ { 3, 2, 2 }, { 3, 1, 2 }, { 3, 0, 2 }, { 1, 2, 2 }, { 1, 1, 2 }, { 1, 0, 2 }, { 2, 2, 2 }, { 2, 1, 2 },
					{ 2, 0, 2 }, { 0, 2, 2 }, { 0, 1, 2 }, { 0, 0, 2 } } };
	...
	public static class Side {
		...
		public void clockWise() {
			...
			for (int i = 0; i < 3; i++) {
				temp[i] = cube[edgeMapping[type][i + 9][0]].color[edgeMapping[type][i + 9][1]][edgeMapping[type][i
						+ 9][2]];
			}
		...
		public void counterClockWise() {
			...
			for (int i = 0; i < 9; i++) {
				cube[edgeMapping[type][i][0]].change(edgeMapping[type][i][1], edgeMapping[type][i][2],
						cube[edgeMapping[type][i + 3][0]].color[edgeMapping[type][i + 3][1]][edgeMapping[type][i
								+ 3][2]]);
			}
