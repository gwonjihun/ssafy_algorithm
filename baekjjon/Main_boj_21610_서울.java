...
public class Main_boj_21610_서울 {
    ...
    // 대각선 체크시 2의 배수만 체크한다.
    static int[][] map;
    static boolean[][] v; // 구름이 내려온 지역 체크
    static int N, M ; // N은 지도의 크기 M은 명령의 갯수
    static Deque<cloud> q; // 구름 저장 공간

    static Deque<int[]> copymagic; // 구름 저장 공간
    static int[][] cmds;
    ...
    public static void main(String[] args) throws Exception {
        ...
        cmds = new int[M][2]; // 0은 방향 1은 이동 거리
...
//                System.out.println(Arrays.toString(a));
//            }
//            System.out.println("---------물복사 끝---------");
//            System.out.print("선택 된 구름 리스트 : ");
